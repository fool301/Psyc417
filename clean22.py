...
file_path = '/Users/fool/Desktop/Edtpa data/All 2022_2023 Scores For Data Analysis.xlsx'
...
# Drop 'FIRST' and 'LAST' columns (optional if you want)
df.drop(columns=['FIRST', 'LAST'], inplace=True, errors='ignore')

# S Move Full_Name to the FIRST column
...
df.to_excel(os.path.join(save_folder, 'cleaned_22-23.xlsx'), index=False)
